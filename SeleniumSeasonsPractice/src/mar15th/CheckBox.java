...
public class CheckBox {
	...
	@Test
	public void checkBoxTest2() throws IOException, InterruptedException
	{
	...
	@Test
	public void checkBoxTest3() throws IOException, InterruptedException
	{
		
		//to validate all the check boxes when all are selected
		List<WebElement> allChecks=driver.findElements(By.xpath("//td[@class='table5']/descendant::input[@type='checkbox']"));
